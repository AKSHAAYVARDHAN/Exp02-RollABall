...
```
## Output:
<img width="1919" height="1100" alt="image" src="https://github.com/user-attachments/assets/ea016ff0-7b6e-463c-8dcf-761c9e7a0896" />

## Result:
Thus the given 3D application to roll a ball in unity is developed sucessfully
